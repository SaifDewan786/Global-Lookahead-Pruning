...
from src.pruning import layerwise_magnitude_pruning
...
def main():
    parser = argparse.ArgumentParser(
        description="Run layerwise magnitude pruning on a causal language model."
    )
    ...
    model = layerwise_magnitude_pruning(
        model=model,
    ...
    results = {
        "model": args.model,
        "method": "layerwise_magnitude_pruning",
